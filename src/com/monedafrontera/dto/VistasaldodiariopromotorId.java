...
public class VistasaldodiariopromotorId implements java.io.Serializable {
	...
	public VistasaldodiariopromotorId(Date fecha, String documento, String promotor, BigDecimal saldoaldia) {
		this.fecha = fecha;
	...
	public boolean equals(Object other) {
		...
		return ((this.getFecha() == castOther.getFecha()) || (this.getFecha() != null && castOther.getFecha() != null
				...
				&& ((this.getSaldoaldia() == castOther.getSaldoaldia())
						|| (this.getSaldoaldia() != null && castOther.getSaldoaldia() != null
								&& this.getSaldoaldia().equals(castOther.getSaldoaldia())));
	}
	...
	public int hashCode() {
		...
		result = 37 * result + (getSaldoaldia() == null ? 0 : this.getSaldoaldia().hashCode());
		return result;
	}
