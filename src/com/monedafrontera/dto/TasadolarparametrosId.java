...
/**
 * TasadolarparametrosId generated by hbm2java
 */
public class TasadolarparametrosId implements java.io.Serializable {
	...
	public TasadolarparametrosId() {
	}

	public TasadolarparametrosId(String codbanco, String codfranquicia, String codpais, Date fechainicio) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TasadolarparametrosId))
			return false;
		TasadolarparametrosId castOther = (TasadolarparametrosId) other;
