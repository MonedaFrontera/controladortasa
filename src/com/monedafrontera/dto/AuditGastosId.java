...
public class AuditGastosId implements java.io.Serializable {
	...
	public AuditGastosId(String documento, Date fecha, Long valor, String observacion, String tipogasto,
			int consecutivo, BigDecimal valorbolivar, String usuariomod, Date fechamod) {
	...
	public boolean equals(Object other) {
		...
		return ((this.getDocumento() == castOther.getDocumento()) || (this.getDocumento() != null
				...
				&& ((this.getTipogasto() == castOther.getTipogasto()) || (this.getTipogasto() != null
						&& castOther.getTipogasto() != null && this.getTipogasto().equals(castOther.getTipogasto())))
	...
	public int hashCode() {
		...
		result = 37 * result + (getTipogasto() == null ? 0 : this.getTipogasto().hashCode());
