...
import com.monedafrontera.dto.Producto;

/**
 * Home object for domain model class Producto.
 * @see com.monedafrontera.dto.Producto
...
public class ProductoHome {
	...
	public Producto findById(java.lang.String id) {
		...
		try {
			Producto instance = (Producto) sessionFactory.getCurrentSession().get("com.monedafrontera.dto.Producto",
					id);
			if (instance == null) {
	...
	public List findByExample(Producto instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.monedafrontera.dto.Producto")
