...
import com.monedafrontera.dto.Usuario;

/**
 * Home object for domain model class Usuario.
 * @see com.monedafrontera.dto.Usuario
...
public class UsuarioHome {
	...
	public Usuario findById(java.lang.String id) {
		...
		try {
			Usuario instance = (Usuario) sessionFactory.getCurrentSession().get("com.monedafrontera.dto.Usuario", id);
			if (instance == null) {
	...
	public List findByExample(Usuario instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.monedafrontera.dto.Usuario")
