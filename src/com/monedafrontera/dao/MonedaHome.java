...
import com.monedafrontera.dto.Moneda;

/**
 * Home object for domain model class Moneda.
 * @see com.monedafrontera.dto.Moneda
...
public class MonedaHome {
	...
	public Moneda merge(Moneda detachedInstance) {
		...
		try {
			Moneda result = (Moneda) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Moneda findById(java.lang.String id) {
		log.debug("getting Moneda instance with id: " + id);
		try {
			Moneda instance = (Moneda) sessionFactory.getCurrentSession().get("com.monedafrontera.dto.Moneda", id);
			if (instance == null) {
	...
	public List findByExample(Moneda instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.monedafrontera.dto.Moneda")
