...
import com.monedafrontera.dto.Sales;
import com.monedafrontera.dto.SalesId;

/**
 * Home object for domain model class Sales.
 * @see com.monedafrontera.dto.Sales
 * @author Hibernate Tools
 */
public class SalesHome {

	private static final Log log = LogFactory.getLog(SalesHome.class);
	...
	public void persist(Sales transientInstance) {
		log.debug("persisting Sales instance");
		try {
	...
	public Sales findById(com.monedafrontera.dto.SalesId id) {
		log.debug("getting Sales instance with id: " + id);
		try {
			Sales instance = (Sales) sessionFactory.getCurrentSession().get("com.monedafrontera.dto.Sales", id);
			if (instance == null) {
	...
	public List findByExample(Sales instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.monedafrontera.dto.Sales")
