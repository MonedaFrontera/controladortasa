...
import com.monedafrontera.dto.Cuenta;

/**
 * Home object for domain model class Cuenta.
 * @see com.monedafrontera.dto.Cuenta
...
public class CuentaHome {
	...
	public Cuenta findById(java.lang.String id) {
		...
		try {
			Cuenta instance = (Cuenta) sessionFactory.getCurrentSession().get("com.monedafrontera.dto.Cuenta", id);
			if (instance == null) {
	...
	public List findByExample(Cuenta instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.monedafrontera.dto.Cuenta")
