...
import com.monedafrontera.dto.Pais;

/**
 * Home object for domain model class Pais.
 * @see com.monedafrontera.dto.Pais
...
public class PaisHome {
	...
	public Pais findById(java.lang.String id) {
		...
		try {
			Pais instance = (Pais) sessionFactory.getCurrentSession().get("com.monedafrontera.dto.Pais", id);
			if (instance == null) {
	...
	public List findByExample(Pais instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.monedafrontera.dto.Pais")
