...
import com.monedafrontera.dto.Rol;

/**
 * Home object for domain model class Rol.
 * @see com.monedafrontera.dto.Rol
...
public class RolHome {
	...
	public Rol findById(int id) {
		...
		try {
			Rol instance = (Rol) sessionFactory.getCurrentSession().get("com.monedafrontera.dto.Rol", id);
			if (instance == null) {
	...
	public List findByExample(Rol instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.monedafrontera.dto.Rol")
