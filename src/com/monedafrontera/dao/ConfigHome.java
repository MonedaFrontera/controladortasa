...
import com.monedafrontera.dto.Config;

/**
 * Home object for domain model class Config.
 * @see com.monedafrontera.dto.Config
...
public class ConfigHome {
	...
	public Config findById(java.lang.Integer id) {
		...
		try {
			Config instance = (Config) sessionFactory.getCurrentSession().get("com.monedafrontera.dto.Config", id);
			if (instance == null) {
	...
	public List findByExample(Config instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.monedafrontera.dto.Config")
