...
import com.monedafrontera.dto.Transaccion;

/**
 * Home object for domain model class Transaccion.
 * @see com.monedafrontera.dto.Transaccion
...
public class TransaccionHome {
	...
	public Transaccion findById(int id) {
		...
		try {
			Transaccion instance = (Transaccion) sessionFactory.getCurrentSession()
					.get("com.monedafrontera.dto.Transaccion", id);
			if (instance == null) {
	...
	public List findByExample(Transaccion instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.monedafrontera.dto.Transaccion")
